    ...
    <div class="navbar-buttons navbar-header pull-right"
      ...
      <ul class="nav ace-nav">
          ...
          <ul
            ...
            <li class="dropdown-content">
              <ul class="dropdown-menu dropdown-navbar navbar-pink">
                ...
                <li><a href="#"> <i
                    class="btn btn-xs btn-primary fa fa-user"></i> Bob
                    just signed up as an editor ...
                </a></li>
        ...
        <li class="green dropdown-modal"><a data-toggle="dropdown"
          class="dropdown-toggle" href="#"> <i
            class="ace-icon fa fa-envelope icon-animated-vertical"></i>
              ...
              <ul class="dropdown-menu dropdown-navbar">
                <li><a href="#" class="clearfix"> <img
                    ...
                    class="msg-body"> <span class="msg-title"> <span
                        class="blue">Alex:</span> Ciao sociis natoque
                        penatibus et auctor ...
                ...
                <li><a href="#" class="clearfix"> <img
                    ...
                    class="msg-body"> <span class="msg-title"> <span
                        class="blue">Susan:</span> Vestibulum id ligula
                        porta felis euismod ...
                    </span> <span class="msg-time"> <i
                ...
                <li><a href="#" class="clearfix"> <img
                    ...
                    class="msg-body"> <span class="msg-title"> <span
                        class="blue">Bob:</span> Nullam quis risus eget
                        urna mollis ornare ...
                    </span> <span class="msg-time"> <i
                ...
                <li><a href="#" class="clearfix"> <img
                    ...
                    class="msg-body"> <span class="msg-title"> <span
                        class="blue">Kate:</span> Ciao sociis natoque
                ...
                <li><a href="#" class="clearfix"> <img
                    ...
                    class="msg-body"> <span class="msg-title"> <span
                        class="blue">Fred:</span> Vestibulum id
                        penatibus et auctor ...
                    </span> <span class="msg-time"> <i
        ...
        <li class="light-blue dropdown-modal"><a data-toggle="dropdown"
          ...
          <ul
            ...
            <li><a href="{{ Uri::to('admin/logout', false, true) }}"> <i class="ace-icon fa fa-power-off"></i>
                Logout
            </a></li>
          </ul></li>
      </ul>
