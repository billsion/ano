...
<div class="row">
    <div class="col-xs-12">
    {{ Form::open(array('url' => Uri::to('system/menu/' . $data['id'], false, true), 'method' => 'PUT', 'id' => 'system-menu-form', 'data-toggle' => 'validator', 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input value="{{ $data['icon'] }}" type="text" name="icon" class="col-xs-10 col-sm-5" placeholder="{{ Lang::get('system::system_menu.icon_placeholder') }}" required /><br/>
            </div>
        </div>
        <div class="form-group">
            	<label class="col-sm-3 control-label no-padding-right">
