...
<div class="row">
    <div class="col-xs-12">
    {{ Form::open(array('url' => Uri::to('system/resource/' . $data['id'], false, true), 'method' => 'PUT', 'id' => 'system-resource-form', 'data-toggle' => 'validator', 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <select name="system_menu_id" class="col-xs-10 col-sm-5" id="select-system_menu_id" required>
                    ...
                    <option <?php if($_menu['id'] == $data['system_menu_id']) {echo 'selected="selected"';}?> value="<?php echo $_menu['id']; ?>"><?php echo $_menu['name']; ?></option>
                    <?php endforeach;?>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input value="{{ $data['pattern'] }}" type="text" name="pattern" class="col-xs-10 col-sm-5" required /><br/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right">
            ...
            <div class="col-sm-9">
                <div class="radio">
							      <label>
										    <input <?php if($data['type'] == 'menu'){echo 'checked="checked"';}?> value="menu" name="type" type="radio" class="ace">
												<span class="lbl"> {{ Lang::get('system::system_resource.type_menu') }}</span>
										</label>
							      <label>
										    <input <?php if($data['type'] == 'action'){echo 'checked="checked"';}?> value="action" name="type" type="radio" class="ace">
												<span class="lbl"> {{ Lang::get('system::system_resource.type_action') }}</span>
										</label>
							      <label>
										    <input <?php if($data['type'] == 'button'){echo 'checked="checked"';}?> value="button" name="type" type="radio" class="ace">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-3" style="padding-top:6px;">
                <label>
            	        <input name="is_menu" value="1" class="ace ace-switch ace-switch-6" <?php if ($data['is_menu']) { echo 'checked="checked"'; }?> type="checkbox">
            					<span class="lbl"></span>
            			</label>
            	</div>
        </div>
        ...
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                ...
                &nbsp; &nbsp; &nbsp;
                <a class="btn btn-yellow" href="{{ Uri::to('system/resource', false, true) }}">
