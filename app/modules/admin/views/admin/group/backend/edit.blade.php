...
<div class="row">
    <div class="col-xs-12">
    {{ Form::open(array('url' => Uri::to('admin/group/' . $data['id'], false, true), 'method' => 'PUT', 'id' => 'admin-group-form', 'data-toggle' => 'validator', 'class' => 'form-horizontal')) }}
            ...
            <div class="col-sm-9">
                <div class="widget-body">
								    <div class="widget-main padding-8">
								        ...
								        <input value="{{ $data['admin_group_id'] }}" type="hidden" id="div-admin_group_id" name="admin_group_id" />
										</div>
								</div>
            </div>
        </div>
...
$('#div_group').jstree({ 
    ...
    $('#div_group').jstree("select_node", '<?php echo $data['admin_group_id']; ?>', true); 
});
</script>
@stop
