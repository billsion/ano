...
<div class="row">
    <div class="col-xs-12">
    {{ Form::open(array('url' => Uri::to('admin/role', false, true), 'method' => 'POST', 'id' => 'admin-role-form', 'data-toggle' => 'validator', 'class' => 'form-horizontal')) }}
								    ...
								    <div class="widget-header widget-header-small">
										    <h6 class="widget-title smaller">{{ $_menu_and_resource['name']; }}</h6>
												<div class="widget-toolbar no-border">
														<label>
															<input name="menu[{{ $_menu_and_resource['id'] }}]" id="input-checkbox-menu-{{ $_menu_and_resource['id']; }}" type="checkbox" class="ace ace-switch ace-switch-4 menus-resources-switch-{{ $_menu_and_resource['id'] }}">
															<span class="lbl middle"></span>
														</label>
												</div>
										</div>

										<div style="display:none;" class="widget-body div-resources-wrapper-{{ $_menu_and_resource['id'] }}">
										    <div class="widget-main">
										        <?php foreach($_menu_and_resource['resources'] as $_resource):?>
										            <label>
														        <input name="menu[{{ $_menu_and_resource['id'] }}][{{ $_resource['id'] }}]" class="ace ace-switch ace-switch-3 menus-resources-switch-{{ $_menu_and_resource['id'] }}" type="checkbox">
